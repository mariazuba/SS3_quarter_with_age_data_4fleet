...
new.esc<-"S4FLEETS_SelECO_Qprior"
...
old.esc<-"S4FLEETS_SelECO_Qprior"
new.esc<-"S4FLEETS_SelECO_QpriorPelEcoR"
dirnew<-paste0(boot,new.esc)
dir.create(dirnew, recursive = TRUE)
...
#'
boot<-"boot/initial/data/run/"
old.esc<-"S4FLEETS_SelECO_QpriorPelEcoR"
new.esc<-"S4FLEETS_SelECO_QpriorEco.Boca"
dirnew<-paste0(boot,new.esc)
dir.create(dirnew, recursive = TRUE)
...
boot<-"boot/initial/data/run/"
old.esc<-"S4FLEETS_SelECO_QpriorPelEcoR"
new.esc<-"S4FLEETS_SelECO_QpriorBoca.EcoR"
dirnew<-paste0(boot,new.esc)
dir.create(dirnew, recursive = TRUE)
...
#'
boot<-"boot/initial/data/run/"
old.esc<-"S4FLEETS_SelECO_QpriorBoca.EcoR"
new.esc<-"S4FLEETS_SelECO_QpriorEcoR"
dirnew<-paste0(boot,new.esc)
dir.create(dirnew, recursive = TRUE)
...
ESCs<-c("S1.0_4FLEETS_SelECO", 
        "S4FLEETS_SelECO_Qprior","S4FLEETS_SelECO_QpriorPelEcoR",
        "S4FLEETS_SelECO_QpriorEco.Boca","S4FLEETS_SelECO_QpriorBoca.EcoR","S4FLEETS_SelECO_QpriorEcoR" )
...
invisible(save_as_image(ft0, path = paste0(path_mod, "/tb_scenarios_Qprior.png")))
...
ggsave(file.path(paste0("report/run/comparison/Qprior","/fig_catchability2.png")), fig_q,  width=8, height=5)
...
SSplotComparisons(mod.sum, subplots=c(13,2,8,10),indexPlotEach = T,
                  ...
                  pheight = 3,png=TRUE,plotdir="report/run/comparison/Qprior",legendloc='topleft')
