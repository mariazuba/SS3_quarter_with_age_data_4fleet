...
```{r}
include_graphics(file.path(path_mod,"tb_scenarios.png"))
```
...
```{r}
path_mod<-"report/run/comparison/Recrindex"
include_graphics(file.path(path_mod,"tb_M.png"))
```


```{r eval=FALSE, fig.width=5, fig.height=6, dpi=300, fig.cap= "Mean age for surveys S1.0_4FLEETS_SelECO"}
