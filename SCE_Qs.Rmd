...
```{r}
include_graphics(file.path("report/run/S1.0_4FLEETS","fig_catchability.png"))
```
...
```{r eval=F,fig.width=5, fig.height=6, dpi=300, fig.cap= "Mean age for surveys S1.0_4FLEETS_SelECO"}
