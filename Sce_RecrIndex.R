...
dat$ctl$natM
#'*===========================================================================*
new.esc<-"S1.0_4FLEETS_SelECO_RecIndex"
...
#'*============================================================================*
dir.create("report/run/comparison/Recrindex", recursive = TRUE)
path_mod<-"report/run/comparison/Recrindex"
...
scenarios <- data.frame(
  Scenario = ESCs,
  Description =  c("base case","Recruits index","Recruits index + M1=1.6","Recruits index + M age-0=2.97,age-1=1.6, age2 and age3 estimate")
)
...
ggsave(file.path(paste0("report/run/comparison/Recrindex","/fig_catchability2.png")), fig_q,  width=8, height=5)
...
SSplotComparisons(mod.sum, subplots=c(13,2,8,10),indexPlotEach = T,
                  ...
                  pheight = 3,png=TRUE,plotdir="report/run/comparison/Recrindex",legendloc='topleft')
