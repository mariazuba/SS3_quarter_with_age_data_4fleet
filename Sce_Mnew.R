...
# run scenarios
ESCs<-c("S4FLEETS_SelECO_Mage",
        "S4FLEETS_SelECO_Mage_M1.4",
        "S4FLEETS_SelECO_Mage_M1.5",
        "S4FLEETS_SelECO_Mage_M1.6")
...
dat$ctl$MG_parms
#'*===========================================================================*
new.esc<-"S4FLEETS_SelECO_Mage_M1.6"
dirnew<-paste0(boot,new.esc)
dat <- r4ss::SS_read(dir = paste0(boot ,new.esc))
...
scenarios <- data.frame(
  Scenario = ESCs,
  Description =  c("Mfix: age-0=2.97, age-1=1.33, Mestimate: age-2 and age-3",
                   "Mfix: age-0=2.97, age-1=1.6, Mestimate: age-2 and age-3")
)
